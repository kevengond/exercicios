...
void lista_conjuntos(Conjunto** c, int conjNum);
...
int 
ElementoConjunto(int elemento, struct Conjunto **c){
    int i;
...
int main(){
    ...
    while(opcao != 0){
        printf("\n\n------------------------------------- Menu -------------------------------------\n");
        if(numeroConjuntos)
            lista_conjuntos(conjs, numeroConjuntos);
        ...
        switch(opcao){
            case 1:
                ...
                else printf("conjunto nao criado\n");
            ...
            case 2:
                ...
                else printf("conjunto nao e vazio\n");
            ...
            case 17:
                ...
                else printf("conjunto %d nao foi destuido\n", i);
